    ...
    render() {
      return (
        ...
        <div>
          ...
          <h2>detalhes</h2>
          <p>montagem e desmontagem de estruturas,
           móveis, painéis,e demais equipamentos, nas
            normas e procedimentos técnicos.</p>
          <p>R$ 290,00</p>
          <Button variant="contained" color="secondary">
             ADD Carrinho
          </Button>        
        ...
        <Card3>
          ...
          <h2>detalhes</h2>
          <p> manutenção, montagem e reparos de instalações
             hidráulicas e pneumáticas como tubulações de água e gás</p>
          <p>R$ 350,00</p>
          <Button variant="contained" color="secondary">
             ADD Carrinho
          </Button>
        ...
        <Card4>
          ...
          <h2>detalhes</h2>
          <p>manutenção corretiva e preventiva em máquinas e
             veículos, envolvendo a troca de peças e limpeza
              de componentes, consertos, revisão de freios,
               direção, regulagem de motores e suspensão.</p>
          <p>R$ 290,00</p>
          <Button variant="contained" color="secondary">
             ADD Carrinho
          </Button>
